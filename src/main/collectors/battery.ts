...
export async function getBatteryMetrics(): Promise<BatteryMetrics> {
  try {
    ...
    if (!data || !data.hasBattery) {
      return {
        hasBattery: false, chargePercent: 0, isCharging: false,
        isPluggedIn: false, timeRemainingMins: null, voltage: null,
        capacityWh: null, designCapacityWh: null, healthPercent: null,
        cycleCount: null, manufacturer: null, model: null,
      }
    }
